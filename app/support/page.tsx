    ...
    <>
      ...
      <main id="content" className="relative pt-28 pb-12" role="main">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <article className="rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-8 lg:p-12 prose prose-invert prose-slate max-w-none" role="article" aria-labelledby="support-heading">
            <h1 id="support-heading" className="text-4xl font-bold text-white mb-2">Support</h1>
            ...
            <div className="space-y-6 text-slate-300">
              ...
              <section><h2 className="text-2xl font-semibold text-white mt-8 mb-4">Self‑Service Links</h2><ul className="list-disc pl-6 space-y-2"><li><a href="/refund-policy" className="text-cyan-400 hover:text-cyan-300">Refund & Billing Policy</a></li><li><a href="/privacy" className="text-cyan-400 hover:text-cyan-300">Privacy Policy</a></li><li><a href="/terms" className="text-cyan-400 hover:text-cyan-300">Terms of Use</a></li><li><a href="/data-deletion" className="text-cyan-400 hover:text-cyan-300">Data Deletion</a></li><li><a href="/cookie-policy" className="text-cyan-400 hover:text-cyan-300">Cookie Policy</a></li><li><a href="/eula" className="text-cyan-400 hover:text-cyan-300">Mobile App EULA</a></li></ul></section>
