...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://unifyn.ai/privacy',
  },
};
      ...
      <main id="content" className="relative pt-28 pb-12" role="main">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <article className="p-8 lg:p-12 max-w-none" role="article" aria-labelledby="privacy-heading">
            <h1 id="privacy-heading" className="text-4xl font-bold text-slate-900 dark:text-slate-100 mb-2">Privacy Policy</h1>
            ...
            <div className="space-y-6 text-slate-700 dark:text-slate-300">
              ...
              <section><h2 className="text-2xl font-semibold text-slate-900 dark:text-slate-100 mt-8 mb-4">2. Scope</h2><p>This policy applies to <a href="https://unifyn.ai" className="text-cyan-600 hover:text-cyan-700 dark:text-cyan-400 dark:hover:text-cyan-300">unifyn.ai</a>, our web app, and our mobile apps available on the Apple App Store and Google Play Store. It also covers in-product notices and any integrations you choose to connect (e.g., brokers, Google services).</p></section>
              ...
              <section><h2 className="text-2xl font-semibold text-slate-900 dark:text-slate-100 mt-8 mb-4">11. Your Rights</h2><p>Depending on your location, you may have rights to access, correct, delete, or export your data; object to or restrict certain processing; and withdraw consent. California residents have additional rights under the CPRA. We do not sell or share personal information for cross‑context behavioral advertising.</p><p>Contact <a href="mailto:legal@unifyn.ai" className="text-cyan-600 hover:text-cyan-700 dark:text-cyan-400 dark:hover:text-cyan-300">legal@unifyn.ai</a> to exercise rights or with questions.</p></section>
              ...
              <section><h2 className="text-2xl font-semibold text-slate-900 dark:text-slate-100 mt-8 mb-4">14. Children’s Privacy</h2><p>Unifyn is intended for individuals 18 years and older. We do not knowingly collect data from children. If you believe a child has provided us information, contact us and we will take appropriate action.</p></section>
              ...
              <section><h2 className="text-2xl font-semibold text-slate-900 dark:text-slate-100 mt-8 mb-4">16. Contact</h2><p>For privacy questions or requests, email <a href="mailto:legal@unifyn.ai" className="text-cyan-600 hover:text-cyan-700 dark:text-cyan-400 dark:hover:text-cyan-300">legal@unifyn.ai</a>. For legal notices, email <a href="mailto:legal@unifyn.ai" className="text-cyan-600 hover:text-cyan-700 dark:text-cyan-400 dark:hover:text-cyan-300">legal@unifyn.ai</a>.</p></section>
              <section><h2 className="text-2xl font-semibold text-slate-900 dark:text-slate-100 mt-8 mb-4">17. Grievance Officer (India)</h2><p>If you have concerns regarding content or data use, contact our Grievance Officer at <a href="mailto:legal@unifyn.ai" className="text-cyan-600 hover:text-cyan-700 dark:text-cyan-400 dark:hover:text-cyan-300">legal@unifyn.ai</a>. We will acknowledge and address complaints in accordance with applicable laws.</p></section>
            </div>
          </article>
        </div>
      </main>
