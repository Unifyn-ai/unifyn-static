...
export default function EulaPage(props: { searchParams?: Promise<{ [key: string]: string | string[] | undefined }> }) {
    ...
    <>
      ...
      <main id="content" className="relative pt-28 pb-12" role="main">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <article className="rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-8 lg:p-12 prose prose-invert prose-slate max-w-none" role="article" aria-labelledby="eula-heading">
            <h1 id="eula-heading" className="text-4xl font-bold text-white mb-2">Mobile App End User License Agreement (EULA)</h1>
            <p className="text-sm text-slate-400 mb-8" role="contentinfo">Last updated: November 16, 2025</p>
            <div className="space-y-6 text-slate-300">
              <section><h2 className="text-2xl font-semibold text-white mt-8 mb-4">1. Agreement</h2><p>This EULA is between you and <strong>Infigon Electric Pvt Ltd</strong> ("Unifyn") and governs your use of Unifyn’s mobile applications for Apple iOS and Google Android (the "Apps").</p></section>
              ...
              <section><h2 className="text-2xl font-semibold text-white mt-8 mb-4">5. Privacy</h2><p>Your use of the Apps is also governed by our <a href="/privacy" className="text-cyan-400 hover:text-cyan-300">Privacy Policy</a>, including disclosures about integrations and Google user data (if you choose to connect Google).</p></section>
              <section><h2 className="text-2xl font-semibold text-white mt-8 mb-4">6. Updates</h2><p>We may from time to time provide updates or upgrades to the Apps, which may be automatically downloaded and installed. Updates are subject to this EULA unless accompanied by a separate license.</p></section>
              <section><h2 className="text-2xl font-semibold text-white mt-8 mb-4">7. Termination</h2><p>This EULA is effective until terminated. Your rights will terminate automatically if you breach the Terms of Use or this EULA. Upon termination, you must cease all use and delete the Apps from your devices.</p></section>
              <section><h2 className="text-2xl font-semibold text-white mt-8 mb-4">8. Disclaimer; Limitation of Liability</h2><p>The Apps are provided "as is" without warranties of any kind. To the maximum extent permitted by law, Unifyn disclaims all liability arising from your use of the Apps. See our <a href="/terms" className="text-cyan-400 hover:text-cyan-300">Terms of Use</a> for more details.</p></section>
              <section><h2 className="text-2xl font-semibold text-white mt-8 mb-4">9. Contact</h2><p>Questions? Contact <a href="mailto:legal@unifyn.trade" className="text-cyan-400 hover:text-cyan-300">legal@unifyn.trade</a>.</p></section>
            </div>
          </article>
        </div>
      </main>
